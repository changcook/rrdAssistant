			...
			success : function(data){
				...
				if(finishrate && finishrate[1]!="100"){
					...
					if(( _rate>14&&_month<=12) || (_rate>=13&&_month<=6)){
						...
						$('#haaway1').html('<a target="_blank" href="http://www.renrendai.com/lend/bidPageAction.action?loanId='+maindata[1]+'">投标 利率='+_rate+'%, '+_month+'个月,完成'+finishrate[1]+'%</a>')
					.css({'margin':'20px','border':'10px solid red','clear':'both'});
						...
						notify(" 有标！rate:"+rates[1]+" \" month:"+months[1]+" \"");
